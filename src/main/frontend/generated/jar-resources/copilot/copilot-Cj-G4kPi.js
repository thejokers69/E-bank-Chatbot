...
}, Ro = process.env.NODE_ENV !== "production" ? Do : {};
function h(e) {
...
var To = {};
function In() {
  return typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : To;
}
var Xr = Object.assign, Mt = Object.getOwnPropertyDescriptor, Y = Object.defineProperty, Yt = Object.prototype, jt = [];
Object.freeze(jt);
var kn = {};
Object.freeze(kn);
...
var ft = typeof Reflect < "u" && Reflect.ownKeys ? Reflect.ownKeys : ei ? function(e) {
...
function yt(e, t, n) {
  if (Z(e, ne) || $t(e, ne, de({}, e[ne])), process.env.NODE_ENV !== "production" && Ut(n) && !Z(e[ne], t)) {
...
ve.diffValueMask_ = 4;
var Mn = /* @__PURE__ */ Ve("Atom", ve);
function ri(e, t, n) {
  t === void 0 && (t = Ue), n === void 0 && (n = Ue);
  var r = new ve(e);
  return t !== Ue && ts(r, t), n !== Ue && Ci(r, n), r;
}
function Wo(e, t) {
  return e === t;
}
...
function Ne(e, t, n) {
  return pt(e) ? e : Array.isArray(e) ? N.array(e, {
    ...
    name: n
  }) : typeof e == "function" && !Fe(e) && !vt(e) ? Qr(e) ? We(e) : ht(n, e) : e;
}
function Ko(e, t, n) {
  if (e == null || Je(e) || cn(e) || pe(e) || J(e))
    return e;
  if (Array.isArray(e))
    return N.array(e, {
      name: n,
...
function ii(e, t, n, r, i) {
  var o, a, s, l, c, u, d;
  i === void 0 && (i = f.safeDescriptors), $o(e, t, n, r);
  var v = r.value;
...
function na(e, t) {
  ...
  return vt(e) || (e = We(e)), (n = this.options_) != null && n.bound && i(function() {
...
function ai(e, t, n, r, i, o) {
  o === void 0 && (o = f.safeDescriptors), ra(e, t, n, r);
  var a = r.value;
  if (vt(a) || (a = We(a)), i) {
    var s;
...
function oa(e, t, n, r) {
  return sa(e, this, t, n), e.defineComputedProperty_(t, de({}, this.options_, {
    get: n.get,
    set: n.set
  }), r);
}
...
function ca(e, t, n, r) {
  var i, o;
  return da(e, this, t, n), e.defineObservableProperty_(t, n.value, (i = (o = this.options_) == null ? void 0 : o.enhancer) != null ? i : Ne, r);
}
function ua(e, t) {
  if (process.env.NODE_ENV !== "production") {
    if (t.kind === "field")
...
var ba = "observable", ma = "observable.ref", ya = "observable.shallow", wa = "observable.struct", li = {
  deep: !0,
  name: void 0,
...
var Sn = /* @__PURE__ */ nn(ba), Aa = /* @__PURE__ */ nn(ma, {
  enhancer: tn
}), Ea = /* @__PURE__ */ nn(ya, {
  enhancer: Ko
}), Oa = /* @__PURE__ */ nn(wa, {
...
function xt(e) {
  return e.deep === !0 ? Ne : e.deep === !1 ? tn : Na(e.defaultDecorator);
}
function Sa(e) {
  var t;
...
var xa = {
  ...
  array: function(t, n) {
    var r = Nt(n);
    return (f.useProxies === !1 || r.proxy === !1 ? Os : hs)(t, xt(r), r.name);
  },
  map: function(t, n) {
    var r = Nt(n);
  ...
  set: function(t, n) {
    var r = Nt(n);
    return new Li(t, xt(r), r.name);
  },
  object: function(t, n, r) {
    return ke(function() {
      return Ri(f.useProxies === !1 || r?.proxy === !1 ? He({}, r) : us({}, r), t, n);
    });
  },
  ref: /* @__PURE__ */ Q(Aa),
  shallow: /* @__PURE__ */ Q(Ea),
  deep: ci,
  struct: /* @__PURE__ */ Q(Oa)
}, N = /* @__PURE__ */ Xr(ui, xa), di = "computed", _a = "computed.struct", Nn = /* @__PURE__ */ jn(di), Pa = /* @__PURE__ */ jn(_a, {
...
Object.assign(rn, Nn);
rn.struct = /* @__PURE__ */ Q(Pa);
var tr, nr, Bt = 0, Ca = 1, Da = (tr = (nr = /* @__PURE__ */ Mt(function() {
...
function Ta(e) {
  Bt !== e.actionId_ && h(30), Bt = e.parentActionId_, e.error_ !== void 0 && (f.suppressReactionErrors = !0), an(e.prevAllowStateChanges_), st(e.prevAllowStateReads_), U(), e.runAsAction_ && oe(e.prevDerivation_), process.env.NODE_ENV !== "production" && e.notifySpy_ && I({
...
var Ia = "create", Oe = /* @__PURE__ */ function(e) {
  function t(r, i, o, a, s) {
    var l;
    return o === void 0 && (o = process.env.NODE_ENV !== "production" ? "ObservableValue@" + F() : "ObservableValue"), a === void 0 && (a = !0), s === void 0 && (s = ze.default), l = e.call(this, o) || this, l.enhancer = void 0, l.name_ = void 0, l.equals = void 0, l.hasUnreportedChange_ = !1, l.interceptors_ = void 0, l.changeListeners_ = void 0, l.value_ = void 0, l.dehancer = void 0, l.enhancer = i, l.name_ = o, l.equals = s, l.value_ = i(r, void 0, o), process.env.NODE_ENV !== "production" && a && P() && _e({
      type: Ia,
      object: l,
  ...
  return t.onBecomeStale_ = function() {
    ...
    else if (mi(this), xn(this)) {
      var r = f.trackingContext;
      this.keepAlive_ && !r && (f.trackingContext = this), this.trackAndCompute() && Ua(this), f.trackingContext = r;
    }
    var i = this.value_;
    if (Tt(i))
      throw i.cause;
    ...
    this.keepAlive_ || (_n(this), this.value_ = void 0, process.env.NODE_ENV !== "production" && this.isTracing_ !== B.NONE && console.log("[mobx.trace] Computed value '" + this.name_ + "' was suspended and it will recompute on the next access."));
...
z.diffValueMask_ = 16;
var sn = /* @__PURE__ */ Ve("ComputedValue", z), y;
(function(e) {
...
function xn(e) {
  switch (e.dependenciesState_) {
    ...
    case y.POSSIBLY_STALE_: {
      for (var t = Un(!0), n = Ie(), r = e.observing_, i = r.length, o = 0; o < i; o++) {
        var a = r[o];
        if (sn(a)) {
...
function hi(e, t, n) {
  ...
  return f.inBatch--, f.trackingDerivation = i, Ma(e), La(e), st(r), o;
}
function La(e) {
...
function yi(e) {
  e.lowestObserverState_ !== y.STALE_ && (e.lowestObserverState_ = y.STALE_, e.observers_.forEach(function(t) {
    t.dependenciesState_ === y.UP_TO_DATE_ && (process.env.NODE_ENV !== "production" && t.isTracing_ !== B.NONE && wi(t, e), t.onBecomeStale_()), t.dependenciesState_ = y.STALE_;
  }));
}
function Ua(e) {
  e.lowestObserverState_ !== y.STALE_ && (e.lowestObserverState_ = y.STALE_, e.observers_.forEach(function(t) {
    t.dependenciesState_ === y.POSSIBLY_STALE_ ? (t.dependenciesState_ = y.STALE_, process.env.NODE_ENV !== "production" && t.isTracing_ !== B.NONE && wi(t, e)) : t.dependenciesState_ === y.UP_TO_DATE_ && (e.lowestObserverState_ = y.UP_TO_DATE_);
  }));
}
function Ba(e) {
...
function wi(e, t) {
  if (console.log("[mobx.trace] '" + e.name_ + "' is invalidated due to a change in: '" + t.name_ + "'"), e.isTracing_ === B.BREAK) {
    var n = [];
    Ai(ns(e), n, 1), new Function(`debugger;
/*
Tracing '` + e.name_ + `'
...
var ee = /* @__PURE__ */ function() {
  ...
  return t.onBecomeStale_ = function() {
    ...
    if (!this.isDisposed) {
      ...
      f.trackingContext = a, this.isRunning = !1, this.isTrackPending = !1, this.isDisposed && _n(this), Tt(s) && this.reportExceptionInDerivation_(s.cause), process.env.NODE_ENV !== "production" && i && I({
        time: Date.now() - o
      }), U();
    }
...
var ir = 100, Fa = function(t) {
  return t();
};
function Ei() {
  f.inBatch > 0 || f.isRunningReactions || Fa(Wa);
}
function Wa() {
...
var Ft = /* @__PURE__ */ Ve("Reaction", ee);
function P() {
...
function qa(e) {
  ...
  }) : (f.spyListeners.push(e), Ln(function() {
    f.spyListeners = f.spyListeners.filter(function(t) {
      return t !== e;
    });
  }));
}
var Bn = "action", Ga = "action.bound", Oi = "autoAction", Ka = "autoAction.bound", Si = "<unnamed action>", Pn = /* @__PURE__ */ At(Bn), Ha = /* @__PURE__ */ At(Ga, {
  bound: !0
}), Cn = /* @__PURE__ */ At(Oi, {
  autoAction: !0
}), Ja = /* @__PURE__ */ At(Ka, {
...
function Ni(e) {
  var t = function(r, i) {
    if (S(r))
      return xe(r.name || Si, r, e);
    if (S(i))
      return xe(r, i, e);
    if (wt(i))
      return (e ? Cn : Pn).decorate_20223_(r, i);
    if (Se(i))
      return yt(r, i, e ? Cn : Pn);
    if (Se(r))
      return Q(At(e ? Oi : Bn, {
        name: r,
        autoAction: e
...
var Ae = /* @__PURE__ */ Ni(!1);
Object.assign(Ae, Pn);
var ht = /* @__PURE__ */ Ni(!0);
Object.assign(ht, Cn);
Ae.bound = /* @__PURE__ */ Q(Ha);
ht.bound = /* @__PURE__ */ Q(Ja);
function Xa(e) {
  return fi(e.name || Si, !1, e, this, void 0);
}
function Fe(e) {
...
function xi(e, t) {
  var n, r, i, o;
  t === void 0 && (t = kn), process.env.NODE_ENV !== "production" && (S(e) || h("Autorun expects a function as first argument"), Fe(e) && h("Autorun does not accept actions since actions are untrackable"));
...
function Pi(e, t, n) {
  var r, i, o;
  n === void 0 && (n = kn), process.env.NODE_ENV !== "production" && ((!S(e) || !S(t)) && h("First and second argument to reaction should be functions"), C(n) || h("Third argument of reactions should be an object"));
  var a = (r = n.name) != null ? r : process.env.NODE_ENV !== "production" ? "Reaction@" + F() : "Reaction", s = Ae(a, n.onError ? Qa(n.onError, t) : t), l = !n.scheduler && !n.delay, c = _i(n), u = !0, d = !1, v, g = n.compareStructural ? ze.structural : n.equals || ze.default, m = new ee(a, function() {
    u || l ? E() : d || (d = !0, c(E));
...
function Ti(e) {
  ...
  return e.observing_ && e.observing_.length > 0 && (t.dependencies = rs(e.observing_).map(Ti)), t;
}
function rs(e) {
...
Vi.prototype = /* @__PURE__ */ Object.create(Error.prototype);
var pn = /* @__PURE__ */ oi("flow"), os = /* @__PURE__ */ oi("flow.bound", {
  bound: !0
...
function as(e, t) {
  return e ? Je(e) || !!e[b] || Mn(e) || Ft(e) || sn(e) : !1;
}
function pt(e) {
...
function us(e, t) {
  var n, r;
  return Yr(), e = He(e, t), (r = (n = e[b]).proxy_) != null ? r : n.proxy_ = new Proxy(e, cs);
}
function L(e) {
...
function ln(e, t, n) {
  return process.env.NODE_ENV !== "production" && (!C(e) && !C(Object.getPrototypeOf(e)) && h("'makeAutoObservable' can only be used for classes that don't have a superclass"), Je(e) && h("makeAutoObservable can only be used on objects not already made observable")), C(e) ? Ri(e, e, t, n) : (ke(function() {
    var r = He(e, n)[b];
    if (!e[gn]) {
...
var ar = "splice", W = "update", ds = 1e4, fs = {
  get: function(t, n) {
    var r = t[b];
  ...
  return t.dehanceValue_ = function(r) {
    ...
    r !== this.lastKnownLength_ && h(16), this.lastKnownLength_ += i, this.legacyMode_ && i > 0 && Ui(r + i + 1);
...
function hs(e, t, n, r) {
  return n === void 0 && (n = process.env.NODE_ENV !== "production" ? "ObservableArray@" + F() : "ObservableArray"), r === void 0 && (r = !1), Yr(), ke(function() {
...
var vs = /* @__PURE__ */ Ve("ObservableArrayAdministration", zn);
function cn(e) {
  return Qt(e) && vs(e[b]);
}
var ps = {}, ce = "add", Zt = "delete", ki = /* @__PURE__ */ function() {
  function e(n, r, i) {
    var o = this;
  ...
  return t.has_ = function(r) {
    ...
    return pe(r) && (r = new Map(r)), re(function() {
      C(r) ? Lo(r).forEach(function(o) {
        return i.set(o, r[o]);
      }) : Array.isArray(r) ? r.forEach(function(o) {
        var a = o[0], s = o[1];
        return i.set(a, s);
      }) : Ge(r) ? (ko(r) || h(19, r), r.forEach(function(o, a) {
        return i.set(a, o);
      })) : r != null && h(20, r);
    }), this;
  }, t.clear = function() {
    ...
    return re(function() {
      ...
      for (var g = Be(o.entries()), m; !(m = g()).done; ) {
        var E = m.value, x = E[0], H = E[1], Le = i.data_.has(x);
      ...
      if (!s)
        if (i.data_.size !== a.size)
          ...
          for (var D = i.data_.keys(), ae = a.keys(), ge = D.next(), $n = ae.next(); !ge.done; ) {
            if (ge.value !== $n.value) {
              i.keysAtom_.reportChanged();
              break;
            }
...
}(), pe = /* @__PURE__ */ Ve("ObservableMap", ki);
function sr(e) {
  return e[Symbol.toStringTag] = "MapIterator", Zn(e);
}
function gs(e) {
  if (Ge(e) || pe(e))
    return e;
...
}(), J = /* @__PURE__ */ Ve("ObservableSet", Li);
function lr(e) {
  return e[Symbol.toStringTag] = "SetIterator", Zn(e);
}
var cr = /* @__PURE__ */ Object.create(null), ur = "remove", Dn = /* @__PURE__ */ function() {
  function e(n, r, i, o) {
    r === void 0 && (r = /* @__PURE__ */ new Map()), o === void 0 && (o = ha), this.target_ = void 0, this.values_ = void 0, this.name_ = void 0, this.defaultAnnotation_ = void 0, this.keysAtom_ = void 0, this.changeListeners_ = void 0, this.interceptors_ = void 0, this.proxy_ = void 0, this.isPlainObject_ = void 0, this.appliedAnnotations_ = void 0, this.pendingKeys_ = void 0, this.target_ = n, this.values_ = r, this.name_ = i, this.defaultAnnotation_ = o, this.keysAtom_ = new ve(process.env.NODE_ENV !== "production" ? this.name_ + ".keys" : "ObservableObject.keys"), this.isPlainObject_ = C(this.target_), process.env.NODE_ENV !== "production" && !zi(this.defaultAnnotation_) && h("defaultAnnotation must be valid annotation"), process.env.NODE_ENV !== "production" && (this.appliedAnnotations_ = {});
  }
  var t = e.prototype;
  return t.getObservablePropValue_ = function(r) {
    ...
    try {
      ...
      if (process.env.NODE_ENV !== "production" && delete this.appliedAnnotations_[r], c && (this.values_.delete(r), c instanceof Oe && (u = c.value_), yi(c)), this.keysAtom_.reportChanged(), (a = this.pendingKeys_) == null || (a = a.get(r)) == null || a.set(r in this.target_), s || l) {
        var v = {
          type: ur,
          observableKind: "object",
          object: this.proxy_ || this.target_,
...
function He(e, t) {
  ...
  if (process.env.NODE_ENV !== "production" && t && Je(e) && h("Options can't be provided for already observable objects."), Z(e, b))
    return process.env.NODE_ENV !== "production" && !(Bi(e) instanceof Dn) && h("Cannot convert '" + qt(e) + `' into observable object:
...
Extending builtins is not supported.`), e;
  ...
  var r = (n = t?.name) != null ? n : process.env.NODE_ENV !== "production" ? (C(e) ? "ObservableObject" : e.constructor.name) + "@" + F() : "ObservableObject", i = new Dn(e, /* @__PURE__ */ new Map(), String(r), Sa(t));
  return $t(e, b, i), e;
}
...
function hr(e, t, n) {
  if (process.env.NODE_ENV !== "production" && !zi(t) && h("Cannot annotate '" + e.name_ + "." + n.toString() + "': Invalid annotation."), process.env.NODE_ENV !== "production" && !Ut(t) && Z(e.appliedAnnotations_, n)) {
...
var ys = /* @__PURE__ */ ji(0), ws = /* @__PURE__ */ function() {
  var e = !1, t = {};
...
var Fn = /* @__PURE__ */ function(e) {
  function t(r, i, o, a) {
    ...
    return o === void 0 && (o = process.env.NODE_ENV !== "production" ? "ObservableArray@" + F() : "ObservableArray"), a === void 0 && (a = !1), s = e.call(this) || this, ke(function() {
      var l = new zn(o, i, a, !0);
      l.proxy_ = s, $r(s, b, l), r && r.length && s.spliceWithArray(0, 0, r), ws && Object.defineProperty(s, "0", ys);
    }), s;
  }
  ni(t, e);
  var n = t.prototype;
...
function Bi(e, t) {
  if (e || h(29), Mn(e) || sn(e) || Ft(e) || pe(e) || J(e))
    return e;
  if (e[b])
    return e[b];
  h(24, e);
...
function Rn(e, t, n, r, i) {
  ...
  if (r.push(e), i.push(t), s) {
    ...
    if (u = d.length, Object.keys(t).length !== u)
      return !1;
    for (; u--; )
      if (v = d[u], !(Z(t, v) && Rn(e[v], t[v], n - 1, r, i)))
        return !1;
  }
  return r.pop(), i.pop(), !0;
}
function pr(e) {
  return cn(e) ? e.slice() : Ge(e) || pe(e) || te(e) || J(e) ? Array.from(e.entries()) : e;
}
var gr, Ss = ((gr = In().Iterator) == null ? void 0 : gr.prototype) || {};
function Zn(e) {
...
const xs = Symbol.for("react.portal"), _s = Symbol.for("react.fragment"), Ps = Symbol.for("react.strict_mode"), Cs = Symbol.for("react.profiler"), Ds = Symbol.for("react.provider"), Rs = Symbol.for("react.context"), Fi = Symbol.for("react.forward_ref"), Ts = Symbol.for("react.suspense"), Vs = Symbol.for("react.suspense_list"), Is = Symbol.for("react.memo"), ks = Symbol.for("react.lazy");
function Ls(e, t, n) {
...
function Vt(e) {
  const t = e.type;
  return t?.$$typeof === Fi && !t.displayName && e.child ? Vt(e.child) : Gt(e.type) ?? Gt(e.elementType) ?? "???";
}
function Fs() {
...
function Gs(e) {
  return typeof e.type != "function" ? !1 : !!(Kt(e) || js(e));
}
const qn = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), Ce = "copilot-", Ks = "24.6.1", Uc = "attention-required", Bc = "https://plugins.jetbrains.com/plugin/23758-vaadin", zc = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode";
function Fc(e) {
...
var Gi = /* @__PURE__ */ ((e) => (e["vaadin-combo-box"] = "vaadin-combo-box", e["vaadin-date-picker"] = "vaadin-date-picker", e["vaadin-dialog"] = "vaadin-dialog", e["vaadin-multi-select-combo-box"] = "vaadin-multi-select-combo-box", e["vaadin-select"] = "vaadin-select", e["vaadin-time-picker"] = "vaadin-time-picker", e["vaadin-popover"] = "vaadin-popover", e))(Gi || {});
const et = {
  "vaadin-combo-box": {
    hideOnActivation: !0,
    open: (e) => Pt(e),
  ...
  "vaadin-select": {
    ...
    open: (e) => {
      const t = e;
      Hi(t, t._overlayElement), t.opened = !0;
    },
    close: (e) => {
      const t = e;
      Ji(t, t._overlayElement), t.opened = !1;
    }
  },
  ...
  e.addEventListener("focusout", Ki, { capture: !0 }), Hi(e), e.opened = !0;
}, Ct = (e) => {
  Ji(e), e.removeAttribute("focused"), e.removeEventListener("focusout", Ki, { capture: !0 }), e.opened = !1;
}, Hi = (e, t) => {
  const n = t ?? e.$.overlay;
...
class il {
  ...
  overlayStatus(t) {
    if (!t)
      return { visible: !1 };
    const n = t.localName;
    let r = Object.keys(Gi).includes(n);
    if (!r)
      return { visible: !1 };
  ...
  constructor() {
    this.dismissedNotifications = [], this.termsSummaryDismissed = !1, this.activationButtonPosition = null, this.paletteState = null, this.activationShortcut = !0, this.activationAnimation = !0, ln(this), this.initializer = new ol(), this.initializer.promise.then(() => {
      Pi(
        () => JSON.stringify(this),
        () => {
          fe("copilot-set-machine-configuration", { conf: JSON.stringify(Sr(this)) });
        }
      );
    }), window.Vaadin.copilot.eventbus.on("copilot-machine-configuration", (t) => {
      const n = t.detail.conf;
      Object.assign(this, Sr(n)), this.initializer.done(!0), t.preventDefault();
    }), this.loadData();
  }
  loadData() {
...
class ll {
  constructor() {
    this._panels = [], this._attentionRequiredPanelTag = null, this._floatingPanelsZIndexOrder = [], this.renderedPanels = /* @__PURE__ */ new Set(), ln(this), this.restorePositions();
  }
  shouldRender(t) {
...
window.Vaadin.copilot.eventbus = new Co();
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const It = globalThis, Kn = It.ShadowRoot && (It.ShadyCSS === void 0 || It.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Hn = Symbol(), Nr = /* @__PURE__ */ new WeakMap();
let Yi = class {
  constructor(t, n, r) {
    if (this._$cssResult$ = !0, r !== Hn) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    if (Kn && t === void 0) {
      ...
      r && (t = Nr.get(n)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), r && Nr.set(n, t));
    }
    return t;
  }
  toString() {
...
}, xr = Kn ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let n = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: fl, defineProperty: hl, getOwnPropertyDescriptor: vl, getOwnPropertyNames: pl, getOwnPropertySymbols: gl, getPrototypeOf: bl } = Object, un = globalThis, _r = un.trustedTypes, ml = _r ? _r.emptyScript : "", yl = un.reactiveElementPolyfillSupport, lt = (e, t) => e, Tn = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? ml : null;
      break;
  ...
  return n;
} }, Qi = (e, t) => !fl(e, t), Pr = { attribute: !0, type: String, converter: Tn, reflect: !1, hasChanged: Qi };
...
let je = class extends HTMLElement {
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const i of r) n.unshift(xr(i));
    } else t !== void 0 && n.push(xr(t));
    return n;
  }
  static _$Eu(t, n) {
    const r = n.attribute;
  ...
  _$EC(t, n) {
    ...
    if (i !== void 0 && r.reflect === !0) {
      const o = (r.converter?.toAttribute !== void 0 ? r.converter : Tn).toAttribute(n, r.type);
  ...
  _$AK(t, n) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const o = r.getPropertyOptions(i), a = typeof o.converter == "function" ? { fromAttribute: o.converter } : o.converter?.fromAttribute !== void 0 ? o.converter : Tn;
      this._$Em = i, this[i] = a.fromAttribute(n, o.type), this._$Em = null;
    }
  }
  requestUpdate(t, n, r) {
    if (t !== void 0) {
      if (r ??= this.constructor.getPropertyOptions(t), !(r.hasChanged ?? Qi)(this[t], n)) return;
      this.P(t, n, r);
    }
...
je.elementStyles = [], je.shadowRootOptions = { mode: "open" }, je[lt("elementProperties")] = /* @__PURE__ */ new Map(), je[lt("finalized")] = /* @__PURE__ */ new Map(), yl?.({ ReactiveElement: je }), (un.reactiveElementVersions ??= []).push("2.0.4");
const Me = Symbol("LitMobxRenderReaction"), Cr = Symbol("LitMobxRequestUpdate");
function wl(e, t) {
  var n, r;
  return r = class extends e {
    ...
    connectedCallback() {
      ...
      this[Me] = new t(`${o}.update()`, this[Cr]), this.hasUpdated && this.requestUpdate();
    }
    disconnectedCallback() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Jn = globalThis, Xt = Jn.trustedTypes, Dr = Xt ? Xt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Xn = "$lit$", ie = `lit$${Math.random().toFixed(9).slice(2)}$`, Yn = "?" + ie, El = `<${Yn}>`, De = document, gt = () => De.createComment(""), bt = (e) => e === null || typeof e != "object" && typeof e != "function", Qn = Array.isArray, $i = (e) => Qn(e) || typeof e?.[Symbol.iterator] == "function", mn = `[ 	
\f\r]`, tt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Rr = /-->/g, Tr = />/g, me = RegExp(`>|${mn}(?:([^\\s"'>=/]+)(${mn}*=${mn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Vr = /'/g, Ir = /"/g, eo = /^(?:script|style|textarea|title)$/i, to = (e) => (t, ...n) => ({ _$litType$: e, strings: t, values: n }), ct = to(1), Xc = to(2), he = Symbol.for("lit-noChange"), O = Symbol.for("lit-nothing"), kr = /* @__PURE__ */ new WeakMap(), Ee = De.createTreeWalker(De, 129);
function no(e, t) {
...
const ro = (e, t) => {
  ...
  for (let s = 0; s < n; s++) {
    const l = e[s];
    let c, u, d = -1, v = 0;
    for (; v < l.length && (a.lastIndex = v, u = a.exec(l), u !== null); ) v = a.lastIndex, a === tt ? u[1] === "!--" ? a = Rr : u[1] !== void 0 ? a = Tr : u[2] !== void 0 ? (eo.test(u[2]) && (i = RegExp("</" + u[2], "g")), a = me) : u[3] !== void 0 && (a = me) : a === me ? u[0] === ">" ? (a = i ?? tt, d = -1) : u[1] === void 0 ? d = -2 : (d = a.lastIndex - u[2].length, c = u[1], a = u[3] === void 0 ? me : u[3] === '"' ? Ir : Vr) : a === Ir || a === Vr ? a = me : a === Rr || a === Tr ? a = tt : (a = me, i = void 0);
    const g = a === me && e[s + 1].startsWith("/>") ? " " : "";
    o += a === tt ? l + El : d >= 0 ? (r.push(c), l.slice(0, d) + Xn + l.slice(d) + ie + g) : l + ie + (d === -2 ? s : g);
  }
  return [no(e, o + (e[n] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), r];
};
class mt {
  constructor({ strings: t, _$litType$: n }, r) {
    ...
    this.parts = [];
    let o = 0, a = 0;
    const s = t.length - 1, l = this.parts, [c, u] = ro(t, n);
    ...
    for (; (i = Ee.nextNode()) !== null && l.length < s; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const d of i.getAttributeNames()) if (d.endsWith(Xn)) {
          const v = u[a++], g = i.getAttribute(d).split(ie), m = /([.?@])?(.*)/.exec(v);
          l.push({ type: 1, index: o, name: m[2], strings: g, ctor: m[1] === "." ? oo : m[1] === "?" ? ao : m[1] === "@" ? so : St }), i.removeAttribute(d);
...
let io = class {
  ...
  u(t) {
    ...
    for (; l !== void 0; ) {
      if (a === l.index) {
        let c;
        l.type === 2 ? c = new Ye(o, o.nextSibling, this, t) : l.type === 1 ? c = new l.ctor(o, l.name, l.strings, this, t) : l.type === 6 && (c = new lo(o, this, t)), this._$AV.push(c), l = r[++s];
      }
...
class Ye {
  ...
  _$AI(t, n = this) {
    t = Re(this, t, n), bt(t) ? t === O || t == null || t === "" ? (this._$AH !== O && this._$AR(), this._$AH = O) : t !== this._$AH && t !== he && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : $i(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  $(t) {
    const { values: n, _$litType$: r } = t, i = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = mt.createElement(no(r.h, r.h[0]), this.options)), r);
    if (this._$AH?._$AD === i) this._$AH.p(n);
    else {
      const o = new io(i, this), a = o.u(this.options);
      o.p(n), this.T(a), this._$AH = o;
    }
  }
  _$AC(t) {
    let n = kr.get(t.strings);
    return n === void 0 && kr.set(t.strings, n = new mt(t)), n;
  }
  k(t) {
...
const Ol = { M: Xn, P: ie, A: Yn, C: 1, L: ro, R: io, D: $i, V: Re, I: Ye, H: St, N: ao, U: so, B: oo, F: lo }, Sl = Jn.litHtmlPolyfillSupport;
Sl?.(mt, Ye), (Jn.litHtmlVersions ??= []).push("3.2.1");
const Nl = (e, t, n) => {
...
function Cl() {
  we.push(import("./copilot-log-plugin-BPSkPKUL.js")), we.push(import("./copilot-info-plugin-DAX7GxFL.js")), we.push(import("./copilot-features-plugin-Sf57yYee.js")), we.push(import("./copilot-feedback-plugin-aYzbzFyU.js")), we.push(import("./copilot-shortcuts-plugin-BhZyJbe8.js"));
}
function Dl() {
  {
...
function Rl() {
  Promise.all(we).then(() => {
    ...
    if (e.copilot.plugins) {
      ...
      e.copilot.plugins.push = (n) => Mr(n), Array.from(t).forEach((n) => {
        Lr.includes(n) || (Mr(n), Lr.push(n));
      });
    }
  }), we = [];
}
...
const Dt = new Tl(), A = window.Vaadin.copilot.eventbus;
if (!A)
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const co = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, uo = (e) => (...t) => ({ _$litDirective$: e, values: t });
class fo {
  constructor(t) {
  }
  get _$AU() {
...
class Vn extends fo {
  constructor(t) {
    if (super(t), this.it = O, t.type !== co.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(t) {
...
const Il = uo(Vn), fn = window.Vaadin.copilot._machineState;
if (!fn)
...
function Ll(e) {
  vo(e) || fn.addDismissedNotification(e);
}
function Ml(e) {
  return !(e.dismissId && (vo(e.dismissId) || p.notifications.find((t) => t.dismissId === e.dismissId)));
}
function po(e) {
  Ml(e) && jl(e);
}
...
const Ul = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  dismissNotification: ho,
  showNotification: po
}, Symbol.toStringTag, { value: "Module" })), Bl = (e) => {
  Te("Unspecified error", e), A.emit("vite-after-update", {});
}, zl = (e, t) => e.error ? (Fl({
  error: e.error,
...
` : ""),
  ...
  go(e.error, e.message, e.stackTrace, e.requestData);
};
function Wl(e, t) {
  go(e, t.message, t.stack || "");
}
function Te(e, t) {
  Gn({
    type: Xe.ERROR,
...
}, Kl = async () => qn(`${Ce}get-user-info`, {}, (e) => (delete e.data.reqId, e.data)), Hl = async () => qi(() => p.userInfo), ru = async () => (await Hl()).vaadiner;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Eo = Symbol.for(""), nc = (e) => {
  if (e?.r === Eo) return e?._$litStatic$;
}, Oo = (e) => ({ _$litStatic$: e, r: Eo }), zr = /* @__PURE__ */ new Map(), rc = (e) => (t, ...n) => {
  const r = n.length;
  let i, o;
  const a = [], s = [];
  let l, c = 0, u = !1;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: ic } = Ol, Fr = () => document.createComment(""), it = (e, t, n) => {
  const r = e._$AA.parentNode, i = t === void 0 ? e._$AB : t._$AA;
  if (n === void 0) {
    const o = r.insertBefore(Fr(), i), a = r.insertBefore(Fr(), i);
...
const hc = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), Zr = { randomUUID: hc };
function No(e, t, n) {
...
const Gr = new _c(), Pc = "copilot-development-setup-user-guide";
function uu() {
  dn("use-dev-workflow-guide"), $.updatePanel(Pc, { floating: !0 });
}
function Po() {
  const e = p.jdkInfo;
...
function du() {
  const e = p.jdkInfo;
  return e == null || Po() !== "success" ? "none" : e.jrebel ? "jrebel" : e.runningWitHotswap ? "hotswap" : "none";
}
function Cc() {
...
class Rc {
  ...
  includeReactNode(t) {
    return Vt(t) === "PreconfiguredAuthProvider" || Vt(t) === "RouterProvider" ? !1 : yr(t) || Gs(t);
  }
  ...
  generateNodeFromFiber(t, n) {
    const r = yr(t) ? Jt(t) : void 0, i = n?.children.length ?? 0;
    return {
      node: t,
      parent: n,
      element: r,
  ...
  generateNodeFromFlow(t, n) {
    ...
    return {
      ...
      isReactComponent: !1,
      get name() {
        return Hs(r) ?? Er(r.element.localName);
      },
      get identifier() {
        return Or(t);
      },
...
let Jr = class extends Pl {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, document.body.style.setProperty("--dev-tools-button-display", "none"), await import("./copilot-global-vars-later-Cmafk9dE.js"), await import("./copilot-init-step2-DpKGNrcj.js"), Vl(), Cl(), this.tabIndex = 0, Dt.hostConnectedCallback(), window.addEventListener("keydown", Br), A.onSend(this.handleSendEvent), this.removers.push(A.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
    ...
    ), ue.getCopilotActivation() && Xi().then(() => {
    ...
    ), bo(), this.initialized = !0, Dc();
  }
  /**
   * Called when Copilot is activated. Good place to start attach listeners etc.
   */
  async activate() {
    dn("activate"), Dt.activate(), Gr.copilotActivated(), Rl(), this.openDrawerIfPanelRequiresAttention(), document.documentElement.addEventListener("mouseleave", this.mouseLeaveListener), nt.onCopilotActivation(), await Tc(), wo.loadPreviewConfiguration(), this.active = !0;
  }
  /**
   * Called when Copilot is deactivated. Good place to remove listeners etc.
   */
  deactivate() {
    this.closeDrawers(), Dt.deactivate(), Gr.copilotDeactivated(), document.documentElement.removeEventListener("mouseleave", this.mouseLeaveListener), nt.onCopilotDeactivation(), this.active = !1;
  }
  disconnectedCallback() {
    super.disconnectedCallback(), Dt.hostDisconnectedCallback(), window.removeEventListener("keydown", Br), A.offSend(this.handleSendEvent), this.removers.forEach((e) => e()), this.removeEventListener("mousemove", this.mouseMoveListener), this.removeEventListener("dragover", this.mouseMoveListener), nt.removeOverlayOutsideClickEvent(), document.documentElement.removeEventListener("vaadin-overlay-outside-click", this.overlayOutsideClickListener);
  }
  handleSendEvent(e) {
